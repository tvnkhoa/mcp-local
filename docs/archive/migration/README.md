...
now, read [`../../architecture/as-built.md`](../../architecture/as-built.md) and [`../../reference/conventions.md`](../../reference/conventions.md).
...
| 5 | [`ci.md`](../../development/ci.md) | What CI covers, what it deliberately does not (no live backends, no secrets), and the script vocabulary that makes the root aggregates work |
...
| **B** Native dependency spike | S-07 | the decision that servers stay outside the npm workspace ([ADR 0001](../../decisions/0001-workspace-native-deps.md)) |
...
[`../../development/backlog.md`](../../development/backlog.md) — the post-migration backlog. Thirteen of fourteen items closed or
...
- [`../../architecture/as-built.md`](../../architecture/as-built.md) — what this is *now*
...
- [`../audit-report.md`](../audit-report.md) — the pre-migration repository at `01c532e`
- [`../../decisions/README.md`](../../decisions/README.md) — the decisions the migration made
