...
harnesses, since a compile-level break should not wait behind the 32 integration harnesses.
...
generated-file drift is caught here or not at all ([`development.md`](../development/workflow.md) §4).

---

## Two things that will waste your afternoon

**`tsc` does not prune `dist/`.** After moving or renaming a source file, the old compiled module
still loads and can mask a broken import. Remedy and detection:
[`../development/workflow.md`](../development/workflow.md) §7.
...
| What is this, as built? | [`architecture.md`](../architecture/as-built.md) |
| The day-to-day loop and the test layers | [`development.md`](../development/workflow.md) |
