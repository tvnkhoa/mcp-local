...
Three servers share the mechanism in `@mcp/shared/sql` but keep their own forbidden-token lists
(18 PostgreSQL / 16 SQLite / 13 DataFusion). Unioning them is wrong because `findForbiddenToken`
