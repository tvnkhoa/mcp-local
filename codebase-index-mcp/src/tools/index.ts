 ...
 *
 * Migrated: read/metadata (8), search (9).
 * Still on the switch: graph/impact (12), indexing/watch (4), refactor (10).
 */
...
export function buildTools(deps: CodebaseIndexDeps): AnyToolDefinition[] {
  return [...buildReadMetadataTools(deps), ...buildSearchTools(deps)];
}
