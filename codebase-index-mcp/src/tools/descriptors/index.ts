/**
 * The `tools/list` descriptors still owned by the legacy `switch` — 10 of the original 43.
 *
 ...
 *
 * Shrinks batch by batch through S-32 and disappears at S-33. Thirty-three tools have moved
 * to `tools/`; their descriptors now live inside those tool definitions. Only refactor is left,
 * which the plan ordered last as the highest-risk group.
 */
